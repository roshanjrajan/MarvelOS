...
void init_paging() {
	...
	kernel_page_table[VIDEO_MEM_INDEX].physical_address = VIDEO_4KB_ALIGNED_ADDRESS >> PDE_PTE_ADDRESS_SHIFT;
	kernel_page_table[VIDEO_MEM_INDEX].open_bits = 0;
	kernel_page_table[VIDEO_MEM_INDEX].global = 1;
	kernel_page_table[VIDEO_MEM_INDEX].reserved_1 = 0;
	kernel_page_table[VIDEO_MEM_INDEX].dirty	= 0;
	kernel_page_table[VIDEO_MEM_INDEX].accessed = 0;
	kernel_page_table[VIDEO_MEM_INDEX].cache_disable = 0;
	kernel_page_table[VIDEO_MEM_INDEX].write_through = 0;
	kernel_page_table[VIDEO_MEM_INDEX].user_supervisor = 0; 
	kernel_page_table[VIDEO_MEM_INDEX].read_write_permissions = 1;
	kernel_page_table[VIDEO_MEM_INDEX].present = 1;
